...
$query= "INSERT INTO `admission` VALUES ('$name','$fname','$mname','$g','$email','$mobile','$class','$subjects','$hobbies','$country','$address','$password','$pic')";
...
{
	echo "<br>"."<br>"."<br>";
	echo "<h4 >Thank you ! " .$name ." Your form successfully submitted .</h4>";
}
else
{
	echo "<br>"."<br>"."<br>";

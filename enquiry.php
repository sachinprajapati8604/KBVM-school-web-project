...
<section class="container mt-4">
	<section class="row" >
		<section class="col-12 col-md-6 mt-5 mx-auto">
			<h5 style=" text-align:center; color:#00f"><u>Enquiry Page</u> </h5> <br>

            <form name="FeedbackForm" action="EnquiryInsert.php" method="POST">
                        <div class="form-row">
                        <div class="col">
                        <label for="exampleInputEmail1">Name</label>
                            <input type="text" class="form-control" name="name" placeholder="enter your name name" required/>
                        </div>
          ...
          <label class="form-check-label" for="gridRadios2">
            Female
				...
				<div class="form-group">
					<label for="exampleFormControlTextarea1">Reason for enquiry </label>

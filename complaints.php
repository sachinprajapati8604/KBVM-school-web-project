...
<section class="container mt-4">
	<section class="row" >
		<section class="col-12 col-md-6 mt-5 mx-auto">
			<h5 style=" text-align:center; color:#00f"><u>Complaint Here</u> </h5> <br>
            
            <form name="FeedbackForm" action="CompInsert.php" method="POST">
                        <div class="form-row">
                        <div class="col">
				...
				<div class="form-group">
					<label for="exampleFormControlTextarea1">Decribe here your complaints </label>
